...
#climate.state<-merge(annseasontpsp, hu12.state, by="hu12_zoneid")
#climate.pdsi<-merge(climate.state, pdsi, by=c("state_name", "year"))
...
#merge in some limno data!
head(lakes.limno)
lakes.limno$yrx1<-lakes.limno$year
climate.yearx<-climate.enso.nao[,c(1:10,15:20,22:29,34:37,40:41 )]
climate.yearx1<-climate.enso.nao[,c(2, 11:17, 21,30:34,38:41)]
