...
n.std$winterprecipsum.n<-n.std$ppt.winter+n.std$November.ppt.x1+n.std$December.ppt.x1+n.std$January.ppt+n.std$February.ppt

p.std$winterprecipsum.p<-p.std$ppt.winter+p.std$November.ppt.x1+p.std$December.ppt.x1+p.std$January.ppt+p.std$February.ppt

sec.std$winteprecipsum.sec<-sec.std$ppt.winter+sec.std$November.ppt.x1+sec.std$December.ppt.x1+sec.std$January.ppt+sec.std$February.ppt

chla.std$winteprecipsum.chla<-chla.std$ppt.winter+chla.std$November.ppt.x1+chla.std$December.ppt.x1+chla.std$January.ppt+chla.std$February.ppt
